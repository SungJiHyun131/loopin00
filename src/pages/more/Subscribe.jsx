...
const infoData = [
  {
    ...
    content: (
      <>
        ...
        <p className='a'>· LOOPIN 구독 시, 다음의 유료 콘텐츠를 이용할 수 있습니다.
            <p>- Calls : 라이브 방송 탐여 및 채팅, VOD 시청</p>
            <p> - Photos : 사진 및 영상 열람</p>
            <p>- Calendar : 아티스트 멤버들의 개인 일정 열람 및 댓글 작성</p>
            <p>- Podcast : 에피소드 시청</p>
        </p>

        <p className='b'>※ 단, Messages는 별도 구독 상품입니다. (아티스트 그룹 내 각 아티스트
          별로 개별 과금) </p>
          <p>· 정기 구독 상품으로서, 구독 갱신일로부터 1개월 또는 1년간의 이용 요금이 매 결제 주기마다 자동 결제됩니다.</p>
          <p>· 구독 시 아티스트 그룹을 복수 선택할 수 있으며, 선택한 그룹에 대한
          구독은 갱신일 기준 3일 전까지 해지할 수 있습니다.</p>
          <p>· LOOPIN 구독의 모든 혜택은 구독 기간 중에만 제공되며, 구독
          기간 만료 시 유료 콘텐츠 및 기능을 이용할 수 없습니다.</p>
          <p>· 유료 콘텐츠는 비정기적으로 업로드되며, 구독 기간 내 콘텐츠
          제공 횟수는 보장되지 않습니다. (콘텐츠 미업로드를 사유로 한
          환불은 불가합니다.)</p>
      </>
    )
  },
    ...
    <div className="container sub">
      <div className="topBox">
        ...
        <div className="ontext">
            ...
            <p className="price">₩ 99,000 <span>/ 매년</span></p>
            <p className="smalltext">· 아티스트와의 채팅/라이브</p>
            <p className="smalltext">· 아티스트와의 사진/영상/일정/팟캐스트</p>
          </div>
